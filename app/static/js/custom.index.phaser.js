window.onload = function() {
    ...
    function create () {
        ...
        //  The score
        weaponCounterText = game.add.text(16, 52, 'Weapon Counter: 0', { fontSize: '32px', fill: '#000' });
       ...
       //  Creates 30 bullets, using the 'bullet' graphic
        ...
        ship = this.add.sprite(400, 300, 'dude');
    ...
    function update() {
        ...
        game.physics.arcade.overlap(ship, stars, collectStar, null, this);
    ...
    function updateWeaponCounter(val){
        weaponCounterText.text = 'Weapons: ' + val;
    }
